...
function M:frame(time) return raw.wl_cursor_frame(self, time) end
...
-- @treturn int The index of the image in the @{image} field that should be displayed for the given time in the cursor animation
function M:frame_and_duration(time, duration) return raw.wl_cursor_frame_and_duration(self, time, duration) end
