...
function M:destroy() raw.wl_cursor_theme_destroy(self) end
...
function M:get_cursor(name) return raw.wl_cursor_theme_get_cursor(self, name) end

-- metatable

function M.mt.__index(_, k) return M[k] end

function M.mt.__tostring(_) return "<wl_cursor_theme>" end

function M.mt.__gc(self) M.destroy(self) end
